        ...
        <div class="scroll-wrapper" ref="scroll">
            <ul class="scroll-content nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item scroll-item">
                    <a class="nav-link active" id="system-tab" data-toggle="pill" href="#system" role="tab" aria-controls="system" aria-selected="true">业务体系</a>
                </li>
                <li class="nav-item scroll-item">
                    <a class="nav-link" id="strategy-tab" data-toggle="pill" href="#strategy" role="tab" aria-controls="strategy" aria-selected="false">战略布局</a>
                </li>
                <li class="nav-item scroll-item">
                    <a class="nav-link" id="agricultrue-tab" data-toggle="pill" href="#agricultrue" role="tab" aria-controls="agricultrue" aria-selected="false">农业生产</a>
                </li>
                <li class="nav-item scroll-item">
                    <a class="nav-link" id="travel-tab" data-toggle="pill" href="#travel" role="tab" aria-controls="travel" aria-selected="false">乡村旅游观光</a>
                </li>
                <li class="nav-item scroll-item">
                    <a class="nav-link" id="ecommerce-tab" data-toggle="pill" href="#ecommerce" role="tab" aria-controls="ecommerce" aria-selected="false">电子商务 + 农业</a>
                </li>
                <li class="nav-item scroll-item">
                    <a class="nav-link" id="plans-tab" data-toggle="pill" href="#plans" role="tab" aria-controls="plans" aria-selected="false">规划计划</a>
                </li>
                <li class="nav-item scroll-item">
                    <a class="nav-link" id="homestay-tab" data-toggle="pill" href="#homestay" role="tab" aria-controls="homestay" aria-selected="false">民宿</a>
                </li>
            </ul>
        </div>
    </div>

    <div class="tab-content font-normal-mobile" id="pills-tabContent">
        ...
        <div class="tab-pane fade" id="agricultrue" role="tabpanel"
             aria-labelledby="agricultrue-tab">
            <div class="blank-block"></div>
            <div class="text-center">
        ...
        <div class="tab-pane fade" id="homestay" role="tabpanel"
