<div class="container-fluid" style="background-color: #222222; height: 200px">
    <div class="container">
        <div class="row justify-content-between" style="color: #fff; position: relative">
            <div class="col-12 col-lg-auto mr-auto" style="position: absolute; bottom: -190px; left: 0px">
                <p>联系我们</p>
                <p style="color: #999; font-size: 16px">联系电话: 400-400-4000</p>
                <p style="color: #999; font-size: 16px">地址: 北京市朝阳区大成国际 B 座 0526 室</p>
            </div>
            <div class="col-12 col-lg-auto" style="position: absolute; bottom: -190px; right: 0">
